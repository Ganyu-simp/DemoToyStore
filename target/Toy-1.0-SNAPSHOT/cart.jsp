                                            ...
                                            <c:forEach items="${list}" var="o">
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="UpdateCart?pid=${o.id}&action=decrease">
                                                            <button class="btnSub">-</button>
                                                        </a>
                                                        <strong>${o.quantity}</strong>
                                                        <a href="UpdateCart?pid=${o.id}&action=increase">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <form action="AddOrder" method="post">
                                        ...
                                        <!-- Nút mua sẽ submit luôn form này -->
                                        <button type="submit" class="btn btn-dark rounded-pill py-2 btn-block mt-3">BUY NOW</button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        ...
                                        <c:set var="vat" value="10" />
                                        <c:set var="total" value="${subtotal + vat}" />
                                        ...
                                        <li class="d-flex justify-content-between py-3 border-bottom">
                                            <strong class="text-muted">Shipping</strong><strong>Free ship</strong>
                                        </li>
                                        <li class="d-flex justify-content-between py-3 border-bottom">
                                            <strong class="text-muted">VAT</strong><strong>${vat} $</strong>
                                        </li>
                                        <li class="d-flex justify-content-between py-3 border-bottom">
