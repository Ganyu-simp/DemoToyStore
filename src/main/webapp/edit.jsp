                    ...
                    <div class="modal-content">
                        <form action="EditProduct" method="post">
                            <div class="modal-header">						
                                ...
                                <a href="ManageProduct" class="close" aria-hidden="true" style="text-decoration: none;">&times;</a>
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="${detail.quantity}" name="quantity" type="number" min="0" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Category</label>
                                    <select name="category" class="form-select" aria-label="Default select example" required>
                                        <c:forEach items="${listC}" var="o">
                                            <option value="${o.cid}" <c:if test="${o.cid == detail.cid}">selected</c:if>>${o.cname}</option>
                                        </c:forEach>
                                    </select>
                                </div>
            ...
            document.querySelector('form[action="edit"]').addEventListener('submit', function (e) {
                ...
                inputs.forEach(function (input) {
                    if (input.hasAttribute('required') && !input.value.trim()) {
                        ...
                        input.style.border = ''; // bỏ lỗi nếu có
                    }
                });
